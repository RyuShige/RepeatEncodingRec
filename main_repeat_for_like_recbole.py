...
from light_sans_simple_repeat import LightSANs_simple_R
...
if __name__ == '__main__':
    ...
    elif args.model == 'LightSANs_simple_R':
        model = LightSANs_simple_R(sessionsetnum, itemnum, repeatnum, args).to(args.device)
    ...
    for epoch in range(epoch_start_idx, args.num_epochs + 1):
        ...
        for step in tqdm(range(num_batch)): # tqdm(range(num_batch), total=num_batch, ncols=70, leave=False, unit='b'):
            ...
            elif args.model == 'SASRec_Repeat' or args.model == 'SASRec_RepeatPlus' or args.model == 'LightSANs' or args.model == 'LightSANs_simple_R' or args.model == 'LightSANs_Repeat':
        ...
        if args.early_stop:
            if early_count == 3:
                ...
                if args.model == 'SASRec':
                    ...
                    fname = 'LightSANs_simple_R_BestModel.MRR={}.epoch={}.lr={}.layer={}.head={}.hidden={}.maxlen={}.pth'
                    fname = fname.format(early_stop, best_epoch, args.lr, args.num_blocks, args.num_heads, args.hidden_units, args.maxlen)
                elif args.model == 'LightSANs_Repeat':
        ...
        if epoch == args.num_epochs:
            ...
            if args.model == 'SASRec':
                ...
                fname = 'LightSANs_simple_R.epoch={}.lr={}.layer={}.head={}.hidden={}.maxlen={}.pth'
                fname = fname.format(best_epoch, args.lr, args.num_blocks, args.num_heads, args.hidden_units, args.maxlen)
            elif args.model == 'LightSANs_Repeat':
